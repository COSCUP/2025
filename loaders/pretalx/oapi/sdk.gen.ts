...
/**
 * API Root
 * Returns a link to the REST API, as well as the pretalx and API versions.
 */
export const apiRetrieve = <ThrowOnError extends boolean = false>(options?: Options<ApiRetrieveData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiRetrieveResponses, unknown, ThrowOnError>({
        url: '/api/',
        ...options
    });
};
 ...
 * Please note that you cannot change an answer’s related objects (question, submission, review, speaker).
 */
...
/**
 * Object changelog
 * Changelog entries related to this object.
 */
export const answersLogList = <ThrowOnError extends boolean = false>(options: Options<AnswersLogListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AnswersLogListResponses, unknown, ThrowOnError>({
 ...
 * List Feedback
 */
export const feedbackList = <ThrowOnError extends boolean = false>(options: Options<FeedbackListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FeedbackListResponses, unknown, ThrowOnError>({
...
/**
 * Create Feedback
 * Submit feedback for a session. This endpoint is publicly accessible.
 */
export const feedbackCreate = <ThrowOnError extends boolean = false>(options: Options<FeedbackCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<FeedbackCreateResponses, unknown, ThrowOnError>({
        url: '/api/events/{event}/feedback/',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * Delete Feedback
 */
export const feedbackDestroy = <ThrowOnError extends boolean = false>(options: Options<FeedbackDestroyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<FeedbackDestroyResponses, unknown, ThrowOnError>({
 ...
 * Show Feedback
 */
export const feedbackRetrieve = <ThrowOnError extends boolean = false>(options: Options<FeedbackRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FeedbackRetrieveResponses, unknown, ThrowOnError>({
        url: '/api/events/{event}/feedback/{id}/',
        ...options
    });
};
 ...
 * Changelog entries related to this object.
 */
export const mailTemplatesLogList = <ThrowOnError extends boolean = false>(options: Options<MailTemplatesLogListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<MailTemplatesLogListResponses, unknown, ThrowOnError>({
 ...
 * Changelog entries related to this object.
 */
export const questionOptionsLogList = <ThrowOnError extends boolean = false>(options: Options<QuestionOptionsLogListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<QuestionOptionsLogListResponses, unknown, ThrowOnError>({
 ...
 */
export const questionsIconRetrieve = <ThrowOnError extends boolean = false>(options: Options<QuestionsIconRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<QuestionsIconRetrieveResponses, unknown, ThrowOnError>({
 ...
 * Changelog entries related to this object.
 */
export const questionsLogList = <ThrowOnError extends boolean = false>(options: Options<QuestionsLogListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<QuestionsLogListResponses, unknown, ThrowOnError>({
 ...
 * Changelog entries related to this object.
 */
export const reviewsLogList = <ThrowOnError extends boolean = false>(options: Options<ReviewsLogListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ReviewsLogListResponses, unknown, ThrowOnError>({
 ...
 * Changelog entries related to this object.
 */
export const roomsLogList = <ThrowOnError extends boolean = false>(options: Options<RoomsLogListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<RoomsLogListResponses, unknown, ThrowOnError>({
 ...
 * Retrieve the content of a specific schedule exporter by name. Requires 'action' permissions.
 */
...
/**
 * Get schedule URL by version
 * This endpoint returns a plain string URL for a specific schedule using its version name (e.g., '1.0', 'My Release') instead of its numeric ID. You have to pass either a version or request the latest version. Returns an empty string if the schedule is not found or not accessible.
 */
export const schedulesByVersionRetrieve = <ThrowOnError extends boolean = false>(options: Options<SchedulesByVersionRetrieveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SchedulesByVersionRetrieveResponses, SchedulesByVersionRetrieveErrors, ThrowOnError>({
 ...
 * Changelog entries related to this object.
 */
export const speakerInformationLogList = <ThrowOnError extends boolean = false>(options: Options<SpeakerInformationLogListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SpeakerInformationLogListResponses, unknown, ThrowOnError>({
 ...
 * Changelog entries related to this object.
 */
export const submissionTypesLogList = <ThrowOnError extends boolean = false>(options: Options<SubmissionTypesLogListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SubmissionTypesLogListResponses, unknown, ThrowOnError>({
...
/**
 * Invite Speaker to Submission
 */
export const submissionsInvitationsCreate = <ThrowOnError extends boolean = false>(options: Options<SubmissionsInvitationsCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SubmissionsInvitationsCreateResponses, unknown, ThrowOnError>({
...
/**
 * Retract Speaker Invitation
 */
export const submissionsInvitationsDestroy = <ThrowOnError extends boolean = false>(options: Options<SubmissionsInvitationsDestroyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<SubmissionsInvitationsDestroyResponses, unknown, ThrowOnError>({
 ...
 * Changelog entries related to this object.
 */
export const submissionsLogList = <ThrowOnError extends boolean = false>(options: Options<SubmissionsLogListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SubmissionsLogListResponses, unknown, ThrowOnError>({
 ...
 */
export const submissionsResourcesCreate = <ThrowOnError extends boolean = false>(options: Options<SubmissionsResourcesCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SubmissionsResourcesCreateResponses, unknown, ThrowOnError>({
...
/**
 * Remove Resource from Submission
 */
export const submissionsResourcesDestroy = <ThrowOnError extends boolean = false>(options: Options<SubmissionsResourcesDestroyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<SubmissionsResourcesDestroyResponses, unknown, ThrowOnError>({
 ...
 * Changelog entries related to this object.
 */
export const tagsLogList = <ThrowOnError extends boolean = false>(options: Options<TagsLogListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TagsLogListResponses, unknown, ThrowOnError>({
 ...
 * Changelog entries related to this object.
 */
export const tracksLogList = <ThrowOnError extends boolean = false>(options: Options<TracksLogListData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TracksLogListResponses, unknown, ThrowOnError>({
...
/**
 * Upload a file (image or PDF) for temporary storage. Allowed file types: PNG, JPEG, GIF, PDF.
 */
